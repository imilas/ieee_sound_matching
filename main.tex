...
\hline
Horner \textit{\textit{et al.}}~\cite{horner1993machine} & Non-diff FM & STFT (McAulay-Quatieri) & GA & Replicate & In & 1991 & Iter \\
\hline
...
\hline
Barkan \textit{et al.}~\cite{barkan2023inversynthII}& Diff. VST Proxy& P-Loss + L1 Spec (weighted) &  Supervised (init.), Semi-Supervised & Replicate& In & 2023 & Both
\\
\hline
