...
This section provides an introduction to digital audio synthesis, audio similarity measures, and a formal definition of sound-matching. We then provide a typology of sound-matching tasks using previous works as well as conceptual approaches that may be promising but rarely explored thus far. Finally, a discussion on the current gaps of knowledge in the field is provided.
...
% In general, relatively small subset of these synthesis methods have been used for automatic sound-matching, notably additive and/or subtractive synthesizers~\cite{esling2019flow,yee2018automatic,mitchell2007evolutionary,salimi2020make}, physical modeling~\cite{riionheimo2003parameter}.
