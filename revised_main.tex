...
\subsection{Heuristics and Historical Framing}
...
Given the different attributes discussed thus far, Table~\ref{tab:summary} contains an overview of relevant literature, covering important works in sound-matching. A more detailed historical analysis of past and current trends in sound-matching can be discussed.
