...
\begin{figure*}[p]
  ...
  \caption{Distributions and ranks of the loss functions based on three different performance measures. From left to right, the performance measures are: Likert, P-Loss, and MSS. Higher values indicate better performance. Rank colors are
