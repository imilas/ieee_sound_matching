...
% Left side: NPSK with MSS
\node[NPSK, text height=5ex, align=center, fill=red!30, draw=black] at (-6,-6) {NPSK with 4 \\ MSS distributions};
...
\node[NPSK, text height=5ex, align=center, fill=blue!40, draw=black] at (0,-6) {NPSK with 4 \\ P-Loss distributions};
...
% Right side: NPSK with Likert
\node[NPSK, text height=5ex, align=center, fill=green!30, draw=black] at (6,-6) {NPSK with 4 \\ Likert distributions};
\draw[->] (6,-6.5) -- (6,-7.5) node[below, below] {\textbf{Ranks 1-4}};
