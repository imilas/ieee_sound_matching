...
\section{Reviewer 4}
\subsection{Use of Appropriate Symbols}
\noindent\textbf{Review:}
...
\noindent\textbf{Response:}
This is a helpful suggestion, and we have made the switch from $x$ and $t$ to $x_{\theta}$ and $x_0$. 

\section{Optimal Targets}
\noindent\textbf{Review:}
...
\subsection{STFT Losses and Time-Shifts}
\noindent\textbf{Review:}
...
\noindent\textbf{Review:}
Just a minor grammar question, Is there a missing subject in the first sentence?While [we] cannot prove ...
