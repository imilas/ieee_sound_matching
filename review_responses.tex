...
\label{}
\noindent{\textbf{Review:}}
Also, in the blinded hearing test, the two listeners are the authors, it seems a bit too biased to me. Not sure how difficult is it to add one more listener, but I believe having an extra sound engineer/musician who is not one of the author would yield a more convincing listening results.
\\
\noindent{\textbf{Response:}}
